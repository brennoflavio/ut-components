    ...
    def __new__(metacls, cls, bases, classdict, *, boundary=None, _simple=False, **kwds):
        ...
        if Flag is None and cls != "Flag" or Flag is not None and not issubclass(enum_class, Flag):
            ...
            if _order_:
                ...
                _order_ = [
                    o for o in _order_ if o not in enum_class._member_map_ or _is_single_bit(enum_class[o]._value_)
                ]
        #
        if _order_:
            ...
            _order_ = [
                ...
                if (
                    ...
                    or (o in enum_class._member_map_ and o in enum_class._member_names_)
                )
            ]
        ...
        try:
            if isinstance(result, cls):
                ...
                if result is None and exc is None:
                    ...
                    exc = TypeError(
                        "error in %s._missing_: returned %r instead of None or a valid member" % (cls.__name__, result)
                    )
